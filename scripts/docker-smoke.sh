...
# Reliable default for YouTube caption smoke (override with DEFAULT_TRANSCRIPT_LANGUAGE=ko, etc.)
export DEFAULT_TRANSCRIPT_LANGUAGE="${DEFAULT_TRANSCRIPT_LANGUAGE:-en}"
