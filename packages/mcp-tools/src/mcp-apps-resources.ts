...
<body>
  ...
  <p>Tool handlers still return JSON for compatibility; the interactive <code>ui/*</code> bridge and bundled UI from <code>apps/mcp-ui-web</code> are expanded in follow-up work. Set <code>SCRIPTIZ_MCP_UI_DIST</code> to a Vite <code>dist</code> directory to serve <code>index.html</code> instead of this placeholder.</p>
</body>
</html>
`;
